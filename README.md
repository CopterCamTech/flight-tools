...
| bin_parameter_compare.py | `.bin`  ArduPilot | FLASK only | Compares parameters from two .bin log files |
...
| `bin_parameter_compare.py` | `http://localhost:5000/bin-parameter-compare` |
